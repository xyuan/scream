...
!    call spmdinit(mpicom_atm, calc_proc_smp_map=.false.)
    write(*,*) "ATM INIT: mpicom=", mpicom_atm
    ...
    ! Initialize pio
    !----------------------------------------------------------------------------
!    print *, 'PIO - TESTING', my_task
!    print *, 'init', mpicom_atm   
!    call pioExInst%init(mpicom_atm)
!    print *, 'decomp' , my_task
!    call pioExInst%createDecomp()
!    print *, 'createfile', my_task   
!    call pioExInst%createFile()
!    print *, 'definevar', my_task   
!    call pioExInst%defineVar()
!    print *, 'writevar', my_task   
!    call pioExInst%writeVar()
!    print *, 'readvar', my_task   
!    call pioExInst%readVar()
!    print *, 'closefile', my_task   
!    call pioExInst%closeFile()
!    print *, 'cleanup', my_task 
!    call pioExInst%cleanUp()
!    print *, 'PIO - TESTING -- Finished', my_task   
