...
!   use cam_abortutils,   only: endrun  !TODO AaronDonahue - make a wrapper for C++ SCREAM command to end the run
...
subroutine endrun()
  ! Do nothing for now.
  ! TODO: Aaron Donahue - make a wrapper for the SCREAM-ithic way to prematurely
  ! end a run.
