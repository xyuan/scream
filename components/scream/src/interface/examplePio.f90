...
module pioExample
    ...
    use spmd_utils ! Aaron Donahue, used to gain access to what would normally be in mpif.h 
...
!!ASDprogram main
!!ASD
!!ASD    use pioExample, only : pioExampleClass
!!ASD
!!ASD    implicit none
!!ASD
!!ASD    type(pioExampleClass) :: pioExInst
!!ASD
!!ASD    call pioExInst%init()
!!ASD    call pioExInst%createDecomp()
!!ASD    call pioExInst%createFile()
!!ASD    call pioExInst%defineVar()
!!ASD    call pioExInst%writeVar()
!!ASD    call pioExInst%readVar()
!!ASD    call pioExInst%closeFile()
!!ASD    call pioExInst%cleanUp()
!!ASD
!!ASDend program main
