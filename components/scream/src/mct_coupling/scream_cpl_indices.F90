...
contains
  ...
  subroutine scream_set_cpl_indices (x2a, a2x)
    ...
    write(*,*) mct_avect_indexra(x2a,'Sx_avsdr')
    write(*,*) mct_avect_indexra(x2a,'Sx_anidr')
    write(*,*) mct_avect_indexra(x2a,'Sx_avsdf')
    write(*,*) mct_avect_indexra(x2a,'Sx_anidf')
    write(*,*) mct_avect_indexra(x2a,'Sx_t')
    write(*,*) mct_avect_indexra(x2a,'So_t')
    write(*,*) mct_avect_indexra(x2a,'Sl_snowh')
    write(*,*) mct_avect_indexra(x2a,'Si_snowh')
    write(*,*) mct_avect_indexra(x2a,'Sl_fv')
    write(*,*) mct_avect_indexra(x2a,'Sl_ram1')
    write(*,*) mct_avect_indexra(x2a,'Sx_tref')
    write(*,*) mct_avect_indexra(x2a,'Sx_qref')
    write(*,*) mct_avect_indexra(x2a,'Sf_ifrac')
    write(*,*) mct_avect_indexra(x2a,'Sf_ofrac')
    write(*,*) mct_avect_indexra(x2a,'Sf_lfrac')
    write(*,*) mct_avect_indexra(x2a,'Sx_u10')
    write(*,*) mct_avect_indexra(x2a,'Faxx_taux')
    write(*,*) mct_avect_indexra(x2a,'Faxx_tauy')
    write(*,*) mct_avect_indexra(x2a,'Faxx_lat')
    write(*,*) mct_avect_indexra(x2a,'Faxx_sen')
    write(*,*) mct_avect_indexra(x2a,'Faxx_lwup')
    write(*,*) mct_avect_indexra(x2a,'Faxx_evap')
    write(*,*) mct_avect_indexra(x2a,'So_ustar')
    write(*,*) mct_avect_indexra(x2a,'So_re')
    write(*,*) mct_avect_indexra(x2a,'So_ssq')
    write(*,*) mct_avect_indexra(x2a,'Fall_flxdst1')
    write(*,*) mct_avect_indexra(x2a,'Fall_flxdst2')
    write(*,*) mct_avect_indexra(x2a,'Fall_flxdst3')
    write(*,*) mct_avect_indexra(x2a,'Fall_flxdst4')
    write(*,*) mct_avect_indexra(x2a,'Sl_soilw',perrWith='quiet')
    write(*,*) mct_avect_indexra(x2a,'Fall_fco2_lnd',perrWith='quiet')
    write(*,*) mct_avect_indexra(x2a,'Faoo_fco2_ocn',perrWith='quiet')
    write(*,*) mct_avect_indexra(x2a,'Faoo_fdms_ocn',perrWith='quiet')
