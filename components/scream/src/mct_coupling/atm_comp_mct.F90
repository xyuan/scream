...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  subroutine atm_init_mct( EClock, cdata, x2a, a2x, NLFilename )
    ...
    use scream_cpl_indices, only: scream_set_cpl_indices, num_exports, num_cpl_imports, num_scream_imports, &
                                  scr_names_x2a, scr_names_a2x, index_x2a, index_a2x, VecComp_x2a, VecComp_a2x
    ...
    call scream_setup_surface_coupling (c_loc(scr_names_x2a), c_loc(index_x2a), c_loc(x2a%rAttr), c_loc(VecComp_x2a), &
                                        num_cpl_imports, num_scream_imports, &
                                        c_loc(scr_names_a2x), c_loc(index_a2x), c_loc(a2x%rAttr), c_loc(VecComp_a2x), &
                                        num_exports)
